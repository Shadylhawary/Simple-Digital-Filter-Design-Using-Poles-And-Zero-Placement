function fifth = fifthOrder_DT(p1)
    %%          Adjusting Variables
    ...
    difference = range(y) ;
    grid on
    title({'Magnitude Response |H(\ite^{\omega t})|';['Passband Ripples =',num2str(difference),'dB'];['At r2 =',num2str(r2),];['At p1 =',num2str(p1),]})
    ...
    %-------------------------------------------------------
    figure('name','5th - Magnitude Response');
    ...
    %-------------------------------------------------------
    figure('name','5th Order - Phase Respone');
    ...
    %-------------------------------------------------------
    figure('name', '5th Order - Group Delay');
    ...
    %-------------------------------------------------------
    figure('name','5th - Impulse Respone');
